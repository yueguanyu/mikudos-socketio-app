...
exports.Authentication = exports.AuthenticationRequest = void 0;
const request_promise_native_1 = __importDefault(require("request-promise-native"));
const lodash_1 = __importDefault(require("lodash"));
const debug_1 = __importDefault(require("debug"));
const debug = debug_1.default('mikudos:authentication');
...
class Authentication {
    constructor(app, { protocol, host, port, path, method, headers } = {
        ...
        method: 'POST',
        headers: {}
    }, { tokenPath = 'accessToken', eventPath = 'authentication', userIdPath = 'user.id', authJoinCallback = async (socket, app, authResult) => { } } = {}) {
        this.app = app;
        this.requsetOption = {
            method: 'POST',
            headers: {
